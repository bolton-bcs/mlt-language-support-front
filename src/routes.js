...
const NewProductForm = React.lazy(() => import('./views/Product/NewProductForm/NewProductForm'));
...
const routes = [
  ...
  {path: BASE_URL + '/manage-products', name: 'Manage Products', component: Product},
  ...
  {path: BASE_URL + '/manage-products/add-new-product',exact: true,  name: 'Add New Product', component: NewProductForm},
